...
class RequestBuilder
{
  public static function createRequest()
  {
    return array(
        'ItemRequest' => array(
            'Scope' => 'List',
            'Fields' => 'CF_YIELD:CF_CLOSE:CF_LAST',
            #'CF_ASK:CF_BID:CF_CLOSE:CF_DATE:CF_EXCHNG:CF_HIGH:CF_LAST:CF_LOW:CF_NETCHNG:CF_SOURCE:CF_TICK:CF_TIME:CF_VOLUME:CF_YIELD:CF_CURRENCY:CF_NAME',
            'RequestKey'=>array(
                array(
                    'Name' => 'ARCPI=ECI',
                    'NameType' => 'RIC'
...
$client2 = new SoapClient("http://api.trkd.thomsonreuters.com/schemas/wsdl/Quotes/Quotes_1_HttpAndRKDToken.wsdl", array('soap_version' => SOAP_1_2, 'trace' => true)); //in order to get the XML response enable trace
